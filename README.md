...
Август — запуск MVP, позволяющего находить и просматривать комплексы, связываться с помощником для более точного подбора и брони/покупки

Сентябрь — информация об отдельных объектах внутри комплекса. Агенты собирающие инфу должны будут сопоставлять разные виды информации (шахматки, планировки и т.д.) чтоб собирать целостные образы объектов
